...
const helper_1 = require("../dot-layer/helper");
...
class AreaLayer extends plot_layer_1.PlotLayer {
    constructor(options) {
        super(options);
        /**
         * 选中数据
         ...
         * 图层类型
         */
        this.type = plot_layer_1.PlotLayer.LayerType.AreaLayer;
        /**
         * 图层是否具有交互属性
         */
        ...
        const defaultState = (0, adaptor_1.getDefaultState)(this.options.state);
        this.name = name ? name : (0, util_1.uniqueId)(this.type);
        this.layer = new l7_1.PolygonLayer(Object.assign(Object.assign({}, config), { name: this.name }));
        this.strokeLayer = new l7_1.LineLayer({ name: 'strokeLayer', visible, zIndex, minZoom, maxZoom });
        this.highlightLayer = new l7_1.LineLayer({
            name: 'highlightLayer',
        ...
        this.selectFillLayer = new l7_1.PolygonLayer({
        ...
        this.selectStrokeLayer = new l7_1.LineLayer({
    ...
    getColorLegendItems() {
        ...
        if (Array.isArray(colorLegendItems) && colorLegendItems.length !== 0) {
            const items = (0, helper_1.getColorLegendItems)(colorLegendItems);
            return items;
        }
        return [];
    }
