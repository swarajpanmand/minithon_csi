...
class Plot extends map_1.Map {
     ...
     */
    createSource() {
        const _a = this.options.source, { data, aggregation } = _a, sourceCFG = tslib_1.__rest(_a, ["data", "aggregation"]);
    ...
    createLabelLayer(source, label, plotLayerConfig) {
        ...
        const textLayer = new text_layer_1.TextLayer(Object.assign({ name: 'labelLayer', visible,
            minZoom,
    ...
    update(options) {
        ...
        if (options.source && !(0, util_1.isEqual)(this.lastOptions.source, this.options.source)) {
            const _a = options.source, { data } = _a, sourceConfig = tslib_1.__rest(_a, ["data"]);
    ...
    changeData(data, cfg) {
        ...
        const _a = this.options.source, { aggregation } = _a, sourceCFG = tslib_1.__rest(_a, ["aggregation"]);
        aggregation && source_1.MappingSource.aggregation(sourceCFG, aggregation);
