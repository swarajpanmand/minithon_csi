...
export const createLightStyleSheet = (cfg = {}) => {
    const { mapStyle = 'light', subColor = 'rgba(0,0,0,0.05)', paletteQualitative10 = QUALITATIVE_10, paletteQualitative20 = QUALITATIVE_20, paletteSemanticRed = '#F4664A', paletteSemanticGreen = '#30BF78', paletteSemanticYellow = '#FAAD14', paletteSequence = SINGLE_SEQUENCE, fontFamily = `"-apple-system", "Segoe UI", Roboto, "Helvetica Neue", Arial,
