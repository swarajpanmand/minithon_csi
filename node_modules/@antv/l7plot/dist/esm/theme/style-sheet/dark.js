...
export const createDarkStyleSheet = (cfg = {}) => {
    const { mapStyle = 'dark', subColor = 'rgba(255,255,255,0.05)', paletteQualitative10 = QUALITATIVE_10, paletteQualitative20 = QUALITATIVE_20, paletteSemanticRed = '#F4664A', paletteSemanticGreen = '#30BF78', paletteSemanticYellow = '#FAAD14', paletteSequence = SINGLE_SEQUENCE, fontFamily = `"-apple-system", "Segoe UI", Roboto, "Helvetica Neue", Arial,
    "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol",
    "Noto Color Emoji"`, } = cfg;
